	...
	public static void main(String[] args) {
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent teclapulsada) {
				...
				Validaciones.validarDouble(teclapulsada, textField);
		...
		textField_1.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent teclapulsada) {
				...
				Validaciones.validarDouble(teclapulsada, textField_1);
		...
		textField_2.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent teclaPulsada2) {
				...
				Validaciones.validarNombre(teclaPulsada2, textField_2);
